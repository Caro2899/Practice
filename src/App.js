          ...
          <div className="selected">
            {selectedItems.length > 0 && (
                <>
                  ...
                  <button className="clear-bt" onClick={this.clearClick}>
                    Clear
                  </button>
                </>
            )}
          ...
          <div className="detail-panel">
            {detail && (
                <div className="products-detail-container">
                  <h4>Index: {detail.code}</h4>
                  <img src={detail.img} alt="error" className="image" />
                  <p>{detail.price}</p>
                  <p>{detail.description}</p>
                  <button onClick={this.backClick} className="back-bt">
                    Back
                  </button>
                </div>
            )}
